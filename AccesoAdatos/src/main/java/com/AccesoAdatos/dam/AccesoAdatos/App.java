			         ...
			         try {
						  ...
						  for(int temp = 0; temp < nList.getLength(); temp++) {
							  ...
							  if(nNode.getNodeType() == Node.ELEMENT_NODE) {
							    ...
							    libro.setGenero(Integer.parseInt(eElement.getElementsByTagName("genero").item(0).getTextContent()));
							    libro.setEdicion(eElement.getElementsByTagName("edicion").item(0).getTextContent());
							    libro.setEditorial(eElement.getElementsByTagName("editoral").item(0).getTextContent());
							    libro.setNcopias(Integer.parseInt(eElement.getElementsByTagName("ncopias").item(0).getTextContent()));
							    arraylibros.add(cont, libro);
					        	cont ++; 							   			
							  }
						  }
